	...
	mount = func(r chi.Router, app *svc.App, hub *ws.Hub) {
		...
		r.Route("/api/v1", func(r chi.Router) {
			...
			r.Route("/planets", func(r chi.Router) {
				...
				r.Get("/{planetID}/buildings", planetViewHandler(app.View.PlanetBuildings))
				r.Get("/{planetID}/facilities", planetViewHandler(app.View.PlanetFacilities))
				r.Get("/{planetID}/research", planetViewHandler(app.View.PlanetResearch))
				r.Get("/{planetID}/shipyard", planetViewHandler(app.View.PlanetShipyard))
				r.Get("/{planetID}/defense", planetViewHandler(app.View.PlanetDefense))
